...
@section('pageTitle', 'Blood Bank | Edit Donor')
            ...
            <div class="ml-auto text-right">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Edit Blood Donor</li>
                    </ol>
                </nav>
            </div>
        </div>
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <form method="POST" action="{{ route('backend.donor.update', $donor->id) }}" enctype="multipart/form-data">
                @method('PUT')       
                {{ csrf_field() }}
